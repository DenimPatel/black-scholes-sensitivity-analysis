    ...
    >
      <Prose>
        <Lead>
          ...
          in a world where <span className="text-white font-semibold">everyone is indifferent to risk</span> — and
        ...
        <Callout kind="watch">
          <p>
            ...
            is exactly one probability measure — the <span className="text-white">risk-neutral measure</span> — under
        ...
        <div>
          <h2 className="text-xl font-semibold text-white mb-3">The distribution</h2>
          <p>
            ...
            probability. The yellow line marks the <span className="text-amber-300">forward price</span>{' '}
        ...
        <WhatYouSee>
          <p>
            The chart is a live simulation of <span className="text-gray-200">5,000 risk-neutral paths</span> of your
            option (fixed seed, so it updates smoothly with the sliders). The cyan shade is the fraction of paths that
            finish <span className="text-cyan-300">past the strike</span>. Switch to the <span className="text-white font-semibold">
        ...
        <div>
          <h2 className="text-xl font-semibold text-white mb-3">Where N(d₂) lives</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold text-white mb-3">What the sliders do to the picture</h2>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <span className="text-gray-200">Volatility</span> widens and flattens the whole curve — more probability
            mass in both tails, which is exactly why options cost more at high σ.
            </li>
            <li>
              <span className="text-gray-200">Time</span> stretches the curve rightward (expected growth at rate r) —
            but remember expected payoff is not price: the discount factor keeps the two from drifting apart.
            </li>
            <li>
              <span className="text-gray-200">The strike</span> is a vertical ruler sliding over a landscape that has not

    ...
    >
      <Prose>
        <Lead>
          ...
          while you hold it. That bleed is called <span className="text-white font-semibold">time decay</span>, and it
        ...
        <WhatYouSee>
          <p>
            ...
            frozen at your slider values. The yellow line marks <span className="text-amber-300">your</span> current
        ...
        <div>
          <h2 className="text-xl font-semibold text-white mb-3">Why the curve is shaped that way</h2>
          <p>
        ...
        <Callout kind="idea">
          <p>
            Theta has a sign, and it depends on who you are. A <span className="text-teal-300">long option</span>'s
            time decay is a cost: daily, all else frozen, the value drops by |θ|. A <span className="text-rose-300">short
        ...
        <div>
          <h2 className="text-xl font-semibold text-white mb-3">Theta is not uniform</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <span className="text-gray-200">At the money</span>, short-dated options decay fastest: maximum
              uncertainty per remaining day, and nowhere else. That is the knee in the chart.
            </li>
            <li>
              <span className="text-gray-200">Deep in the money</span>, the option behaves almost like the stock
              itself — theta is small because there is almost no time value left to lose.
            </li>
            <li>
              <span className="text-gray-200">Deep out of the money</span>, the option is so far from the strike that
        ...
        <Callout kind="watch">
          <p>
            One exception that bites: a <span className="text-white font-semibold">deep in-the-money put</span>'s theta
        ...
        <Callout kind="try">
          <p>
            Drag <span className="text-white font-semibold">time to maturity</span> from 2 years down to one month
